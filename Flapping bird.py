...
def draw_floor():
	screen.blit(floor_surface,(floor_x_pos,573))
	screen.blit(floor_surface,(floor_x_pos + 576,573))
...
def check_collision(pipes):
	...
	if bird_rect.top <= -100 or bird_rect.bottom >= 573:
		return False
...
# Create the screen
pygame.init()
screen = pygame.display.set_mode((576,675))
...
bird_rect = bird_surface.get_rect(center = (100,337.5))
...
pipe_height = [200,300,400,450,500]

# Display message
game_over_surface = pygame.image.load('message.png').convert_alpha()
game_over_rect = game_over_surface.get_rect(center = (288,337.5))
